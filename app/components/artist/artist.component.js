...
var ArtistComponent = (function () {
    function ArtistComponent(_searchService, _route) {
    ...
    ArtistComponent.prototype.ngOnInit = function () {
        ...
        this._route.params
            ...
            _this._searchService.getArtist(id)
                .subscribe(function (artist) {
                _this.artist = artist;
            });
            _this._searchService.getAlbums(id)
    ...
    ArtistComponent = __decorate([
        ...
        __metadata('design:paramtypes', [spotify_service_1.SearchService, router_1.ActivatedRoute])
    ], ArtistComponent);
